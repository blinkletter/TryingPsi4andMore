# stolen from https://github.com/lcbc-epfl/iesm-public/blob/main/iesm/Exercises/helpers.py
# For full set of psi4 examples see https://github.com/lcbc-epfl/iesm-public
# https://lcbc-epfl.github.io/iesm-public/intro.html
